...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (document.querySelector('#main-search')) {
        new LiveSearch('#main-search', '#live-search-results-container');
    }

    // Initialize live search for mobile
    if (document.querySelector('#mobile-search-input')) {
        new LiveSearch('#mobile-search-input', '#mobile-search-results');
    }
